                      ...
                      child: GetBuilder<HomeController>(
                        builder: (context) {
                          return Column(
                            children: [
                              Text(
                                  "No of Alphabet Should be entered ${homeController.columns.value}",style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold),),
                              const SizedBox(
                                height: 20,
                              ),
                              ...
                              ElevatedButton(
                                  onPressed: () {
                                    if (formkeynext.currentState!.validate()) {
                                      Get.to(()=>(GridviewScreenView(alphabets:homeController.alphabetController.text,
                                        columns: homeController.columns.toInt(),
